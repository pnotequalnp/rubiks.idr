...
public export
Generate (S 8) RUF where
  p <++> R  = p <+> (MkS . asVect) [[0, 1, 7, 4]]
  p <++> U  = p <+> (MkS . asVect) [[0, 1, 2, 3]]
  p <++> F  = p <+> (MkS . asVect) [[0, 4, 5, 3]]
  p <++> R2 = p <+> (MkS . asVect) [[0, 7], [1, 4]]
  p <++> U2 = p <+> (MkS . asVect) [[0, 2], [1, 3]]
  p <++> F2 = p <+> (MkS . asVect) [[0, 5], [3, 4]]
  p <++> R' = p <+> (MkS . asVect) [[0, 4, 7, 1]]
  p <++> U' = p <+> (MkS . asVect) [[0, 3, 2, 1]]
  p <++> F' = p <+> (MkS . asVect) [[0, 3, 5, 4]]
...
public export
Generate (S 12) RUF where
  p <++> R  = p <+> (MkS . asVect) [[1, 5, 11, 4]]
  p <++> U  = p <+> (MkS . asVect) [[0, 1, 2, 3]]
  p <++> F  = p <+> (MkS . asVect) [[0, 4, 8, 7]]
  p <++> R2 = p <+> (MkS . asVect) [[1, 11], [4, 5]]
  p <++> U2 = p <+> (MkS . asVect) [[0, 2], [1, 3]]
  p <++> F2 = p <+> (MkS . asVect) [[0, 8], [4, 7]]
  p <++> R' = p <+> (MkS . asVect) [[1, 4, 11, 5]]
  p <++> U' = p <+> (MkS . asVect) [[0, 3, 2, 1]]
  p <++> F' = p <+> (MkS . asVect) [[0, 7, 8, 4]]
